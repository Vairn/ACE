...
/** @deprecated Prefer endianNativeToLittle16 — kept for older ACE call sites. */
static inline UWORD endianLittle16(UWORD uwIn) {
	return endianNativeToLittle16(uwIn);
}

/** @deprecated Prefer endianNativeToLittle32 */
static inline ULONG endianLittle32(ULONG ulIn) {
	return endianNativeToLittle32(ulIn);
}

/** @deprecated Prefer endianBigToNative16 */
static inline UWORD endianBig16(UWORD uwIn) {
	return endianBigToNative16(uwIn);
}

/** @deprecated Prefer endianBigToNative32 */
static inline ULONG endianBig32(ULONG ulIn) {
	return endianBigToNative32(ulIn);
}
